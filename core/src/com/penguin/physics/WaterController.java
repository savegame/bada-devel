...
public class WaterController {
	...
	public WaterController(World world, Fixture fluidSensor) {
		this.world = world;
	...
	public void step() {
		for (Fixture fixture : fixtures) {
			...
			if (fixture.getBody().isAwake()) {
				...
				List<Vector2> clippedPolygon = com.penguin.physics.PolygonIntersector.clipPolygons(
	...
	private void applyForces(Fixture fixture, Vector2[] clippedPolygon) {
		com.penguin.physics.PolygonProperties polygonProperties = com.penguin.physics.PolygonIntersector
